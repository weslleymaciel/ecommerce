...
import { ProdutoComponent } from '../scripts/produto/produto.component';
...
export class AppComponent {
  ...
  handleTotalValor(totalValor) {
    this.totalValor = totalValor;
  }

  handleTotalCarrinho(totalCarrinho) {
